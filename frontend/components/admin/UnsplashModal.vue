    ...
    >
      ...
      >
        ...
        <div class="p-6 border-b border-gray-800">
          ...
          <!-- Search Bar -->
          <div class="mt-4">
            <form @submit.prevent="searchImages" class="flex gap-2">
              <input
                v-model="searchQuery"
                type="text"
                placeholder="搜尋圖片..."
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-else-if="error" class="text-center py-12">
            ...
            <button @click="searchImages" class="btn-secondary mt-4">
              重試
            </button>
          </div>
            ...
            >
              ...
              >
                <div class="text-center p-4">
                  ...
                  <p class="text-gray-300 text-xs mt-1">點擊選擇</p>
                </div>
              </div>
              <!-- Attribution -->
              <div
          ...
          <div v-else class="text-center py-12">
            ...
            <p class="text-gray-400">輸入關鍵字搜尋圖片</p>
          </div>
...
// 方法
const searchImages = async (reset = true) => {
