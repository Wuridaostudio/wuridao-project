...
export class AddExcerptAndAuthorToArticles1753319700318
  implements MigrationInterface
{
  name = 'AddExcerptAndAuthorToArticles1753319700318';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "articles" ADD "excerpt" character varying`,
    );
