<template>
  <div class="min-h-screen bg-black text-white">
    ...
    >
      <nav class="flex justify-between items-center w-full px-8 h-20">
        <!-- Logo -->
        <NuxtLink
          to="/"
...
.nav-link-mobile {
  @apply text-gray-300 hover:text-white transition-colors py-2 px-4 rounded-lg hover:bg-gray-800;
}
