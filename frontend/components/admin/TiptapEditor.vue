        ...
        <div v-if="editor">
          <div ref="editorContainerRef" class="tiptap-editor">
            ...
            <div class="toolbar">
              ...
              <!-- 媒體 -->
              <div class="toolbar-group">
                <button type="button" title="插入圖片" @click="triggerImageUpload">
                  🖼️ 圖片
                </button>
                <button type="button" title="插入圖片網址" @click="insertImageByUrl">
                  🌐 圖片網址
                </button>
                <button type="button" title="插入表格" @click="insertTable">
                  📊 表格
                </button>
                <button type="button" title="插入連結" @click="setLink">
                  🔗 連結
                </button>
              </div>
              ...
              <!-- 編輯操作 -->
              <div class="toolbar-group">
                <button type="button" title="復原 (Ctrl+Z)" @click="editor.chain().focus().undo().run()">
                  ↺
                </button>
                <button type="button" title="重做 (Ctrl+Y)" @click="editor.chain().focus().redo().run()">
                  ↻
                </button>
              </div>
            ...
            >
              <input v-model="colorValue" type="color" @change="applyColor">
            ...
            <div v-if="showLinkDialog" class="link-dialog">
              <div class="link-dialog-content">
                ...
                <div class="link-dialog-buttons">
                  <button class="btn-primary" @click="insertLink">
                    插入
                  </button>
                  <button class="btn-secondary" @click="closeLinkDialog">
                    取消
                  </button>
                </div>
              </div>
